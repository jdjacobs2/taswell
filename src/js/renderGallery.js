...
import IMG_3937 from '../img3/IMG_3937.jpg';
...
import IMG_4089 from '../img3/IMG_4089.jpg';
...
import IMG_4298_HDR from '../img3/IMG_4298_HDR.jpg';
import IMG_4307_HDR_Edit from '../img3/IMG_4307_HDR_Edit.jpg';
import IMG_4339_HDR from '../img3/IMG_4339_HDR.jpg';
...
const data = [
  ...
  [IMG_3758, 'Windsong Adventuras View', 'full hull'],
  [IMG_3762, 'Windsong at Adventuras Dock', 'full hull'],
  ...
  [IMG_4044_Edit, 'Tashing Brass Threshold Plate', 'hull'],
  ...
  [IMG_4198, 'Guest Cabin Mattress Mat', 'guest cabin'],
  [IMG_4339_HDR, 'Guest Head', 'guest head'],
  [IMG_4361_HDR, 'Guest Head', 'guest head'],
  [IMG_4371_HDR, 'Guest Head', 'guest head'],
  [IMG_3921, 'Salon Liquor Cabinet', 'salon'],
  [IMG_3937, 'Captains Chairs', 'salon'],
  [IMG_3938, 'Salon Wine Cabinet', 'salon'],
  [IMG_4270_HDR, 'Salon Cocktail Table', 'salon'],
  [IMG_4271_HDR_Edit, "Captain's Chairs", 'salon'],
  [IMG_4298_HDR, 'Salon Banquette', 'salon'],
  [IMG_4307_HDR_Edit, 'Salon Half Large Table', 'salon'],
  [IMG_3782, 'Galley', 'galley'],
  [IMG_4089, 'BBQ', 'galley'],
  [IMG_4093, 'Fiberglass Propane Tank', 'galley'],
  [IMG_4149, 'BBQ', 'galley'],
  ...
  [IMG_3773, '62 STAndersen variable speed electric winches ', 'sails'],
